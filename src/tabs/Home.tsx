    ...
    <div className="space-y-16">
      <section className="min-h-[80vh] flex items-center">
        <div className="max-w-4xl">
          <div className="inline-block px-4 py-2 bg-linear-to-r from-blue-500/10 to-purple-500/10 rounded-full mb-6 border border-blue-500/20">
          ...
          <div className="flex gap-4 flex-wrap">
            <button
              ...
              className="px-8 bg-linear-to-r from-blue-500 to-purple-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 transform hover:scale-105"
            >
              View Projects
            </button>
            <button
